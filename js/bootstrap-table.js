...
(function ($) {
    ...
    BootstrapTable.prototype.fitHeader = function () {
        ...
        fixedBody.scrollHeight > fixedBody.clientHeight + this.$header.outerHeight() ?
            getScrollBarWidth() : 0;*/
        /*调整条件语句,解决了浏览器在特定高度出现table表头和内容不对齐情况 by mg*/
        scrollWidth = fixedBody.scrollWidth > fixedBody.clientWidth &&
        ...
        /*自动移动滑动条,会使table表头自动对齐内容 by mg*/
        var scrollLeft = $(fixedBody).scrollLeft()+1
        $(fixedBody).scrollLeft(scrollLeft)
        scrollLeft = $(fixedBody).scrollLeft()-1
        $(fixedBody).scrollLeft(scrollLeft)
